...
if [ $# -ge 1 ]; then
    ...
    if [ $1 = 'stl2obj' ]; then 
        ...
        INPUT=( 
                ...
                # 'data/Hook_bar-hanging_exp/Hook_bar-hanging_exp_headphone_20' \
                # 'data/Hook_bar-hanging_exp/Hook_bar-hanging_exp_headphone_22' \
        ...
        OBJECT=(
            'Hook_60-hanging_exp_bag_5', 
            'Hook_60-hanging_exp_daily_5', 
            'Hook_60-hanging_exp_mug_59', 
        )
        for input in "${INPUT[@]}"
        do
