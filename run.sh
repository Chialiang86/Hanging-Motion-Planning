...
if [ $# -ge 1 ]; then
    ...
    if [ $1 = 'stl2obj' ]; then 
        ...
        INPUT=( 
            'data/data_all_new_testing_stable/Hook_hcu_190_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hcu_293_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hcu_359_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hcu_362_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hcu_390_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hcu_75_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hs_190_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hs_216_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hs_314_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hs_317_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hs_370_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hs_70_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hsr_125_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hsr_381_easy-everyday_objects'
            'data/data_all_new_testing_stable/Hook_hsr_71_easy-everyday_objects'

            # 'data/data_all_new_testing_stable/Hook_hcu_134_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_243_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_296_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_303_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_306_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_335_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_364_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_229_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_293_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_123_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_15_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_22_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_298_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_56_normal-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_5_normal-everyday_objects'

            # 'data/data_all_new_testing_stable/Hook_hcu_138_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_181_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_380_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_3_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_105_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_117_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_154_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_156_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_42_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_94_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_118_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_263_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_304_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_335_hard-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_391_hard-everyday_objects'

            # 'data/data_all_new_testing_stable/Hook_hcu_104_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_279_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_376_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hcu_89_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_275_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_339_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_363_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_393_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hs_95_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_13_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_218_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_312_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_321_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_hsr_371_devil-everyday_objects'
            # 'data/data_all_new_testing_stable/Hook_omni_124_devil-everyday_objects'
        )
        ...
        for (( i=0; i<$length; i++ )) 
        do
            LOG_FILE="nce_package/res_easy_${i}_new.txt"
            # python3 hanging_env.py -ir ${INPUT[$i]} #> $LOG_FILE
