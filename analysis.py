...
def main(args):
    ...
    out_path = f'analysis/{prefix}_{time_stamp}.csv'
    out_data = []
    ...
    # time distribution
    out_path = f'analysis/{prefix}_{time_stamp}_distribution.png'
    bins = range(0, 100, 5)
    ...
    # heatmap
    out_path = f'analysis/{prefix}_{time_stamp}_heatmap.png'
